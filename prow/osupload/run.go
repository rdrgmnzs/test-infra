...
func (o Options) Run(spec *downwardapi.JobSpec, extra map[string]objectstorage.UploadFunc) error {
	...
	if !o.DryRun {
		...
		gcsClient, err := objectstorage.ClientWithCreds(ctx, o.Bucket, o.GcsCredentialsFile)
		if err != nil {
...
func PathsForJob(options *kube.GCSConfiguration, spec *downwardapi.JobSpec, subdir string) (string, string, objectstorage.RepoPathBuilder) {
