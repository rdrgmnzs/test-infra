...
func (o *Options) Validate() error {
	...
	if !o.DryRun {
		if o.Bucket == "" {
			return errors.New("no object storage bucket was provided")
		}
	}
	...
	if o.PathStrategy != kube.PathStrategyLegacy && o.PathStrategy != kube.PathStrategyExplicit && o.PathStrategy != kube.PathStrategySingle {
		return fmt.Errorf("object storage path strategy must be one of %q, %q, or %q", kube.PathStrategyLegacy, kube.PathStrategyExplicit, kube.PathStrategySingle)
	}

	if o.PathStrategy != kube.PathStrategyExplicit && (o.DefaultOrg == "" || o.DefaultRepo == "") {
		return fmt.Errorf("default org and repo must be provided for object storage strategy %q", o.PathStrategy)
	}
