...
// PathForSpec determines the objectstorage path prefix for files uploaded
...
// AliasForSpec determines the object storage path aliases for a job spec
...
// LatestBuildForSpec determines the object storage path for storing the latest
...
// RootForSpec determines the root object storage path for storing artifacts about
// the provided job.
...
// RepoPathBuilder builds object storage path segments and embeds defaulting behavior
